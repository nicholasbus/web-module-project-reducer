...
import './App.css';
import { applyNumber, changeOperation, clearDisplay, addToMemory, resetToMemory, memoryReset } from './actions'
        ...
        <div className="col-md-12 d-flex justify-content-center">
          <form name="Cal">
            ...
            <div className="row">
              ...
              <CalcButton value={"MR"} onClick={() => dispatch(resetToMemory(state.memory))}/>
